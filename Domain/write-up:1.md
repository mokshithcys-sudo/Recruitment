Firstly, I chose red teaming as my preferred domain, and the first task I was given was to create a basic website. I was told that I should build it using the LAMP stack.

Then, I installed apache2 and mysql-server in my terminal. Then, I installed PHP for the backend code along with php-mysql, which helps PHP scripts communicate with the MySQL database.
